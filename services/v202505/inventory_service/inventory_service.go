...
type CreateAdUnits struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createAdUnits"`

	AdUnits []*AdUnit `xml:"adUnits,omitempty" json:"adUnits,omitempty"`
}

type CreateAdUnitsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createAdUnitsResponse"`
...
type GetAdUnitSizesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getAdUnitSizesByStatement"`
...
type GetAdUnitSizesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getAdUnitSizesByStatementResponse"`

	Rval []*AdUnitSize `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetAdUnitsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getAdUnitsByStatement"`

	FilterStatement *Statement `xml:"filterStatement,omitempty" json:"filterStatement,omitempty"`
}

type GetAdUnitsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getAdUnitsByStatementResponse"`

	Rval *AdUnitPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformAdUnitAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performAdUnitAction"`
...
type PerformAdUnitActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performAdUnitActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateAdUnits struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateAdUnits"`

	AdUnits []*AdUnit `xml:"adUnits,omitempty" json:"adUnits,omitempty"`
}

type UpdateAdUnitsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateAdUnitsResponse"`
