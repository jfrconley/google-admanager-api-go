...
type CreateCreatives struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createCreatives"`

	Creatives []*Creative `xml:"creatives,omitempty" json:"creatives,omitempty"`
}

type CreateCreativesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createCreativesResponse"`
...
type GetCreativesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getCreativesByStatement"`
...
type GetCreativesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getCreativesByStatementResponse"`

	Rval *CreativePage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformCreativeAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performCreativeAction"`
...
type PerformCreativeActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performCreativeActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateCreatives struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateCreatives"`

	Creatives []*Creative `xml:"creatives,omitempty" json:"creatives,omitempty"`
}

type UpdateCreativesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateCreativesResponse"`
