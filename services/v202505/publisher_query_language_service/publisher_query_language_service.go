...
type Select_ struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 select"`

	SelectStatement *Statement `xml:"selectStatement,omitempty" json:"selectStatement,omitempty"`
}

type SelectResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 selectResponse"`
