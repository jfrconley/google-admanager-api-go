...
type CreateCompanies struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createCompanies"`

	Companies []*Company `xml:"companies,omitempty" json:"companies,omitempty"`
}

type CreateCompaniesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createCompaniesResponse"`
...
type GetCompaniesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getCompaniesByStatement"`
...
type GetCompaniesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getCompaniesByStatementResponse"`

	Rval *CompanyPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformCompanyAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performCompanyAction"`
...
type PerformCompanyActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performCompanyActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateCompanies struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateCompanies"`

	Companies []*Company `xml:"companies,omitempty" json:"companies,omitempty"`
}

type UpdateCompaniesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateCompaniesResponse"`
