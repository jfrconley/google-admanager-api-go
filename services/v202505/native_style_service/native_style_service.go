...
type CreateNativeStyles struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createNativeStyles"`

	NativeStyles []*NativeStyle `xml:"nativeStyles,omitempty" json:"nativeStyles,omitempty"`
}

type CreateNativeStylesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 createNativeStylesResponse"`
...
type GetNativeStylesByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getNativeStylesByStatement"`
...
type GetNativeStylesByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 getNativeStylesByStatementResponse"`

	Rval *NativeStylePage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformNativeStyleAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performNativeStyleAction"`
...
type PerformNativeStyleActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 performNativeStyleActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateNativeStyles struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateNativeStyles"`

	NativeStyles []*NativeStyle `xml:"nativeStyles,omitempty" json:"nativeStyles,omitempty"`
}

type UpdateNativeStylesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202505 updateNativeStylesResponse"`
