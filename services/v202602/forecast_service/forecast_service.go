...
type BuyerPermissionType string
...
const (
	...
	//
	BuyerPermissionTypeNEGOTIATOR_ONLY BuyerPermissionType = "NEGOTIATOR_ONLY"

	//
	// All buyers under the listed buyer's bidder can transact on the line item.
	//
	BuyerPermissionTypeBIDDER BuyerPermissionType = "BIDDER"

	//
	// The value returned if the actual value is not exposed by the requested API version.
	//
	BuyerPermissionTypeUNKNOWN BuyerPermissionType = "UNKNOWN"
)
...
const (
	...
	//
	SupplyPathTypeDIRECT SupplyPathType = "DIRECT"

	//
	// The deal's demand will be supplied by a demand side platform (DSP).
	//
	SupplyPathTypeDEMAND_SIDE_PLATFORM SupplyPathType = "DEMAND_SIDE_PLATFORM"

	//
	// The value returned if the actual value is not exposed by the requested API version.
	//
	SupplyPathTypeUNKNOWN SupplyPathType = "UNKNOWN"
)
...
const (
	...
	TargetingDimensionVERTICAL TargetingDimension = "VERTICAL"

	TargetingDimensionCONTENT_LABEL TargetingDimension = "CONTENT_LABEL"

	TargetingDimensionPUBLISHER_PROVIDED_SIGNALS TargetingDimension = "PUBLISHER_PROVIDED_SIGNALS"
...
type GetAvailabilityForecast struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAvailabilityForecast"`
...
type GetAvailabilityForecastResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAvailabilityForecastResponse"`
...
type GetAvailabilityForecastById struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAvailabilityForecastById"`
...
type GetAvailabilityForecastByIdResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAvailabilityForecastByIdResponse"`

	Rval *AvailabilityForecast `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetDeliveryForecast struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDeliveryForecast"`
...
type GetDeliveryForecastResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDeliveryForecastResponse"`

	Rval *DeliveryForecast `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetDeliveryForecastByIds struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDeliveryForecastByIds"`
...
type GetDeliveryForecastByIdsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDeliveryForecastByIdsResponse"`

	Rval *DeliveryForecast `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetTrafficData struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getTrafficData"`
...
type GetTrafficDataResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getTrafficDataResponse"`
...
type ProposalLineItem struct {
	...
	//
	SupplyPath *SupplyPathType `xml:"supplyPath,omitempty" json:"supplyPath,omitempty"`
	...
	//
	// <ul>
	// <li>{@link BuyerPermissionType#NEGOTIATOR_ONLY} means that only the buyer listed on the deal
	// can bid on the deal.
	// <li>{@link BuyerPermissionType#BIDDER} means that all buyers under the listed buyer's bidder
	// can bid on the deal.
	// </ul>
	//
	BuyerPermissionType *BuyerPermissionType `xml:"buyerPermissionType,omitempty" json:"buyerPermissionType,omitempty"`
	...
	//
	// <p>The field {@link ProposalLineItem#netRate} is required, and used to calculate {@link
	...
	//
	// The {@code AllocationDeliveryProfile} ID for this proposal line item.
	//
	DeliveryAllocationProfileId int64 `xml:"deliveryAllocationProfileId,omitempty" json:"deliveryAllocationProfileId,omitempty"`
}
