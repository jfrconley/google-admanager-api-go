...
const (
	...
	// items. The {@link LineItem#lineItemType} must be {@link LineItemType#STANDARD}
	//
	CostTypeCPCV CostType = "CPCV"
...
const (
	...
	// seconds between targeted {@code DateTime}s.
	//
	DateTimeRangeTargetingError_ReasonBLACKOUT_DURATION_TOO_SHORT DateTimeRangeTargetingError_Reason = "BLACKOUT_DURATION_TOO_SHORT"
...
const (
	...
	//
	// The placeholders are invalid because they contain a creative count of more than 1 but the
	// environment does not support this or the line item has repeated creative serving enabled.
	//
	LineItemError_ReasonPLACEHOLDER_COUNT_NOT_SUPPORTED LineItemError_Reason = "PLACEHOLDER_COUNT_NOT_SUPPORTED"
	...
	//
	LineItemError_ReasonTARGET_PLATFORM_NOT_ALLOWED LineItemError_Reason = "TARGET_PLATFORM_NOT_ALLOWED"
	...
	//
	// The line item type is invalid for the specified allocation delivery profile.
	//
	LineItemError_ReasonINVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE LineItemError_Reason = "INVALID_LINE_ITEM_TYPE_FOR_ALLOCATION_DELIVERY_PROFILE"
...
//
// The reasons for the targeting error.
//

type PublisherProvidedSignalsTargetingError_Reason string
...
const (
	...
	//
	PublisherProvidedSignalsTargetingError_ReasonUNTARGETABLE_CATEGORY PublisherProvidedSignalsTargetingError_Reason = "UNTARGETABLE_CATEGORY"

	//
	// A category that is targeted cannot also be excluded.
	//
	PublisherProvidedSignalsTargetingError_ReasonTARGETED_CATEGORIES_NOT_EXCLUDABLE PublisherProvidedSignalsTargetingError_Reason = "TARGETED_CATEGORIES_NOT_EXCLUDABLE"

	//
	// Indicates that the category is sensitive or does not exist.
	//
	PublisherProvidedSignalsTargetingError_ReasonCATEGORY_NOT_FOUND PublisherProvidedSignalsTargetingError_Reason = "CATEGORY_NOT_FOUND"

	PublisherProvidedSignalsTargetingError_ReasonUNKNOWN PublisherProvidedSignalsTargetingError_Reason = "UNKNOWN"
)
...
const (
	...
	// for standard reservation video line items. The {@link LineItem#lineItemType} must be {@link
	// LineItemType#STANDARD}.
	//
	UnitTypeCOMPLETED_VIEWS UnitType = "COMPLETED_VIEWS"
...
type CreateLineItems struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createLineItems"`

	LineItems []*LineItem `xml:"lineItems,omitempty" json:"lineItems,omitempty"`
}

type CreateLineItemsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createLineItemsResponse"`
...
type GetLineItemsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getLineItemsByStatement"`
...
type GetLineItemsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getLineItemsByStatementResponse"`

	Rval *LineItemPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformLineItemAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performLineItemAction"`
...
type PerformLineItemActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performLineItemActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateLineItems struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateLineItems"`

	LineItems []*LineItem `xml:"lineItems,omitempty" json:"lineItems,omitempty"`
}

type UpdateLineItemsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateLineItemsResponse"`
...
type LineItemSummary struct {
	...
	//
	// The {@code AllocationDeliveryProfile} ID for this line item.
	//
	DeliveryAllocationProfileId int64 `xml:"deliveryAllocationProfileId,omitempty" json:"deliveryAllocationProfileId,omitempty"`
}
...
type PublisherProvidedSignalsTargetingError struct {
	*ApiError

	//
	// The error reason represented by an enum.
	//
	Reason *PublisherProvidedSignalsTargetingError_Reason `xml:"reason,omitempty" json:"reason,omitempty"`
}
