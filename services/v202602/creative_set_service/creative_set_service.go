...
type CreateCreativeSet struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createCreativeSet"`

	CreativeSet *CreativeSet `xml:"creativeSet,omitempty" json:"creativeSet,omitempty"`
}

type CreateCreativeSetResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createCreativeSetResponse"`
...
type GetCreativeSetsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCreativeSetsByStatement"`

	Statement *Statement `xml:"statement,omitempty" json:"statement,omitempty"`
}

type GetCreativeSetsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCreativeSetsByStatementResponse"`

	Rval *CreativeSetPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateCreativeSet struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateCreativeSet"`

	CreativeSet *CreativeSet `xml:"creativeSet,omitempty" json:"creativeSet,omitempty"`
}

type UpdateCreativeSetResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateCreativeSetResponse"`
