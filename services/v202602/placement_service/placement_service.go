...
type CreatePlacements struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createPlacements"`

	Placements []*Placement `xml:"placements,omitempty" json:"placements,omitempty"`
}

type CreatePlacementsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createPlacementsResponse"`
...
type GetPlacementsByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getPlacementsByStatement"`
...
type GetPlacementsByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getPlacementsByStatementResponse"`

	Rval *PlacementPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformPlacementAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performPlacementAction"`
...
type PerformPlacementActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performPlacementActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdatePlacements struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updatePlacements"`

	Placements []*Placement `xml:"placements,omitempty" json:"placements,omitempty"`
}

type UpdatePlacementsResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updatePlacementsResponse"`
