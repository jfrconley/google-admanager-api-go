...
type GetAllNetworks struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAllNetworks"`
}

type GetAllNetworksResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAllNetworksResponse"`
...
type GetCurrentNetwork struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCurrentNetwork"`
}

type GetCurrentNetworkResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCurrentNetworkResponse"`

	Rval *Network `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetDefaultThirdPartyDataDeclaration struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDefaultThirdPartyDataDeclaration"`
}

type GetDefaultThirdPartyDataDeclarationResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getDefaultThirdPartyDataDeclarationResponse"`

	Rval *ThirdPartyDataDeclaration `xml:"rval,omitempty" json:"rval,omitempty"`
}

type MakeTestNetwork struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 makeTestNetwork"`
}

type MakeTestNetworkResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 makeTestNetworkResponse"`

	Rval *Network `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateNetwork struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateNetwork"`

	Network *Network `xml:"network,omitempty" json:"network,omitempty"`
}

type UpdateNetworkResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateNetworkResponse"`
