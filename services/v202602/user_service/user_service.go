...
type CreateUsers struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createUsers"`

	Users []*User `xml:"users,omitempty" json:"users,omitempty"`
}

type CreateUsersResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 createUsersResponse"`
...
type GetAllRoles struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAllRoles"`
}

type GetAllRolesResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getAllRolesResponse"`

	Rval []*Role `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetCurrentUser struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCurrentUser"`
}

type GetCurrentUserResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getCurrentUserResponse"`

	Rval *User `xml:"rval,omitempty" json:"rval,omitempty"`
}

type GetUsersByStatement struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getUsersByStatement"`
...
type GetUsersByStatementResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 getUsersByStatementResponse"`

	Rval *UserPage `xml:"rval,omitempty" json:"rval,omitempty"`
}

type PerformUserAction struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performUserAction"`
...
type PerformUserActionResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 performUserActionResponse"`

	Rval *UpdateResult `xml:"rval,omitempty" json:"rval,omitempty"`
}

type UpdateUsers struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateUsers"`

	Users []*User `xml:"users,omitempty" json:"users,omitempty"`
}

type UpdateUsersResponse struct {
	XMLName xml.Name `xml:"https://www.google.com/apis/ads/publisher/v202602 updateUsersResponse"`
